...
export default class FailSendPin extends React.Component{
    constructor(props){
        super(props);
        this.state={
        ...
        return(
            <Fragment>
                ...
                <div style= {styles.styleContent}>
                    ...
                    <div>
                        Gửi PINCode không thành công
                        <div style={styles.linesecond}>
                        Nguyên nhân: <span style={{color: 'red'}}>Không tìm thấy dữ liệu email của nhân viên.</span>
                        </div>
                    </div>
                </div>
