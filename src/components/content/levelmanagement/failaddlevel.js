...
export default class FailAddLevel extends React.Component{
    constructor(props){
        super(props);
        this.state={
    ...
    render(){
        return(
            ...
            <div style= {styles.styleContent}>
                ...
                <div>
                    Thêm mới tầng không thành công
                    <div style={styles.linesecond}>
                    Nguyên nhân: <span style={{color: 'red'}}>Tầng đã tồn tại trong hệ thống</span>
                    </div>
                </div>
            </div>
