...
export default class LockerFree extends React.Component{
    constructor(props){
        super(props);
        this.state={
    ...
    onAcceptClick =() => {
        ...
        return new Promise((resolve, reject) => {
            Locker.confirmLocker(lId)
            .then(res => {
                if (res) {
                    if (res.code && res.code === ResponseCode.confirm_locker_success) {
                        resolve();
                        this.props.data.callback();
                    }
                    else {
        ...
        return(
            <Fragment>
                ...
                <div style= {styles.styleContent}>
                    <div >
                        <TableIcons.Email style={{color: green[500], fontSize: 60}}/>
                    </div>
                    <div>
