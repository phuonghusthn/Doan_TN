...
export default class SuccessEditTagEmployee extends React.Component{
    constructor(props){
        super(props);
        this.state={
    ...
    render() {
        return(
            <Fragment>
                ...
                Thay đổi thông tin thiết bị điều khiển                </div>
                <div style= {styles.styleContent}>
                    <div>
                        <TableIcons.DoneAll style={{ color: green[500], fontSize: 60}}/>
                    </div>
                    <div>
                    Thay đổi thông tin thiết bị điều khiển thành công                    </div>
                </div>
